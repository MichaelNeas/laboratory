...
enum SequenceType: CaseIterable {
    case oneNoBomb, one, twoWithOnceBomb, two, three, four, chain, fastChain
}
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        sequence = [.oneNoBomb, .two, .twoWithOnceBomb, .twoWithOnceBomb, .three, .one, .chain]
    ...
    func createSlices() {
        // skshapenode is great for drawing shapes
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        // only enter loop if node is skpritenode
    ...
    func createEnemy(forceBomb: ForceBomb = .random) {
        ...
        let randomPosition = CGPoint(x: Int.random(in: 64...860), y: -128)
